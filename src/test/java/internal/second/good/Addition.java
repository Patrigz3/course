...
public class Addition {
    ...
    public static void main(String[] args) {
        ...
        //Do we really need sum variable? No! :

        System.out.println("sum is " + (number1 + number2)); //display sum
    }

    private static int getInputNumberFrom(Scanner scanner, String inputMessage) { //Applied DAMP ((Descriptive And Meaningful Phrases) & not visible from outside Addition class
        System.out.print(inputMessage); //prompt
        return scanner.nextInt(); //read internal.first number from user
    }
