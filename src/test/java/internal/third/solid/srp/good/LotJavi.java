package internal.third.solid.srp.good;

public class LotJavi implements Printable {

    private String lotNumber;
    private String controlName;

    public LotJavi(String lotNumber, String controlName) {  //Constructor to be invoked to create objects from the class specification
